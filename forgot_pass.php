<?php 
    ...
    if(isset($_POST['Forgot_sub'])){
        $Check_phone = $con->prepare("SELECT Victim_email,Victim_Phoneno FROM victim WHERE Victim_Phoneno=?");
        $phone=$_POST['PhoneNo'];
    ...
    if(isset($_POST['reset'])){
        ...
        //   echo "pass hash: ".$pass_enc;
                $query="UPDATE victim SET Victim_pass = ? WHERE Victim_Phoneno = ?";
                // echo($query);
    ...
    <h2>Forgot Password</h2>
        <?php 
            ...
            <div class="container" id="resetpass">
                <form action="forgot_pass.php" method="post" style="border:1px solid #ccc">
        ...
        <div class="container" id="enterotp">
            <form action="forgot_pass.php" method="post" style="border:1px solid #ccc"><label><b>Enter OTP</b></label>
